...
fix trackrdf all ave/time 1 1 1000 c_myrdf[1] c_myrdf[2] file {rdf_file} mode vector 
...
def main():
    ...
    for idx, seed in enumerate(seeds):
        edited = prod_template.format(random_seed=seed, rdf_file=f'rdf_{idx+1}.dat', T=T, msd_file=f'msd_{idx+1}.dat')
